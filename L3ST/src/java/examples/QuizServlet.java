...
/*    @RequestMapping(value = "/QuizServlet", method = RequestMethod.POST)
    public String submitBoxes(@RequestParam("name")String[] checkboxValue,@RequestParam("action") String action){
    ...
    public String boxes(@RequestParam("value") String value){ //Question q
    
  //  public String boxes(@RequestParam("q1")String[] checkboxValue){
        for (int i = 0; i < 9; i++){
        if(value == null)
            return null;
        }
